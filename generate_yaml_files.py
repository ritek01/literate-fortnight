...
def main():
    ...
    harness_dir = os.path.join(os.getcwd(), '.harness/orgs/webhook_test/projects/new_proj/services')
    ...
    print(f"Successfully generated 521 YAML files in {harness_dir}")
